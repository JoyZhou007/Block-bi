...
const NamedModulePlugin = require('webpack/lib/NamedModulesPlugin');
//const NamedChunksPlugin = require('webpack/lib/NamedChunksPlugin');

/**
 * Webpack Constants
 */
const ENV = process.env.NODE_ENV = process.env.ENV = 'uat';
...
const biConfig = require('./bi-config').biConfig;
module.exports = function (env) {
  return webpackMerge(commonConfig({
    ...
    output: {
       ...
       */
      sourceMapFilename: '[name].bundle.map?[chunkhash]',
    ...
    devServer: {
      ...
      proxy : [{
        path: '/'+ biConfig.apiPrefix,
        target: biConfig.apiDomain,
        changeOrigin: true}
      ]
    },

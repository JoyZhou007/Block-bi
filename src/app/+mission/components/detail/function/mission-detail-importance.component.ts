import {Component,OnInit, ViewChild,Inject,Input,Renderer} from '@angular/core';
import * as MissionConstant from '../../../../shared/config/mission.config';

@Component({
  selector: 'read-importance',
  templateUrl: '../../../template/detail/function/mission-detail-importance.component.html'
})


export class MissionDetailImportanceComponent {
  ...
  ngOnInit(){
    ...
    if(!this.missionDetailData.isReset && this.missionDetailData.fns.hasOwnProperty(MissionConstant.MISSION_FUNCTION_IMPORTANCE)){
      this.displayData1.perm = parseInt(this.missionDetailData.fns[MissionConstant.MISSION_FUNCTION_IMPORTANCE].value);
    }
  }
